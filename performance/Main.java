...
public class Main {
    public static void main(String[] args) {
        ...
        double totalGeometry = 0;
        long startGeometry = System.currentTimeMillis();
        for (int i = 0; i < 1000000; i++) {
            totalGeometry += testGeometry(vector3_1, vector3_2, radius1, radius2, radius3);
        }
        long finishGeometry = System.currentTimeMillis();
        System.out.println("total geometry = " + totalGeometry);
    ...
    public static double testGeometry(double[] vector3_1, double[] vector3_2, double radius1, double radius2, double radius3) {
        return Math.sqrt(Math.pow(vector3_2[0] - vector3_1[0], 2) + Math.pow(vector3_2[1] - vector3_1[1], 2) + Math.pow(vector3_2[2] - vector3_1[2], 2));
    }
